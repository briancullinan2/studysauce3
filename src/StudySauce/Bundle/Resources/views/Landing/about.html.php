...
<div id="warp">
    ...
    <div class="main">
        <div class="head">
            ...
            <p>We wanted to express our gratitude to the dedicated staff of Archway Classical Academy - Scottsdale.  In particular, thank you to Mr. Kuhlman, Mrs. Armstrong, Mr. Hull, Mrs. Gonzalez, and the 1st and 4th grade teachers.  Thank you so much for your help in getting Study Sauce started!</p>
        </div>
    </div>
</div>
<?php $view['slots']->stop(); ?>
