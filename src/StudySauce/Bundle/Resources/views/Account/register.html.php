    ...
    <div class="pane-content">
        ...
        <form action="<?php print $view['router']->generate('account_create'); ?>" method="post">
            ...
            <div class="first-name">
                <label class="input"><input type="text" name="first" placeholder="First name" value="<?php print (isset($first) ? $first : ''); ?>"></label>
            </div>
            <div class="last-name">
                <label class="input"><input type="text" name="last" placeholder="Last name" value="<?php print (isset($last) ? $last : ''); ?>"></label>
            </div>
            <div class="email">
                <label class="input"><input type="text" name="email" placeholder="Email" value="<?php print (isset($email) ? $email : ''); ?>"></label>
            </div>
            <div class="password">
                <label class="input"><input type="password" name="pass" placeholder="Enter password" value=""></label>
            </div>
