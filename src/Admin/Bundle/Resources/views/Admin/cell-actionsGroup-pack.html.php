...
<div class="highlighted-link">
    ...
    <a title="Remove membership"
       ...
       data-action="<?php print $view['router']->generate('save_group', ['groupId' => $searchRequest['ss_group-id'], 'packId' => $pack->getId(), 'groups' => [['remove' => 'true', 'id' => $searchRequest['ss_group-id']]]]); ?>"
