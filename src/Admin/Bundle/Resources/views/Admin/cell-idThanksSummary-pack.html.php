...
$retention = $results['payment'][0]->getUser()->getUserPacks()->toArray();
$card = 0;
...
<div class="pack-icon"><?php
    ...
    ?>
    <label class="highlighted-link"><a href="<?php print ($view['router']->generate('cards', ['card' => $card])); ?>" class="btn">Study now</a></label>
