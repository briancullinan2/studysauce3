...
<div class="highlighted-link">
    ...
    <?php }
        ...
        <a href="#general-dialog" data-confirm="Are you sure you would like to delete the group &ldquo;<?php print ($ss_group->getName()); ?>&rdquo; permanently?" class="remove-icon" data-action="<?php print ($view['router']->generate('save_group', ['ss_group' => ['id' => $ss_group->getId(), 'deleted' => 1], 'tables' => ['ss_group' => ['name', 'deleted']]])); ?>" data-target="#general-dialog" data-toggle="modal">&nbsp;</a>
    <?php } ?>
</div>
