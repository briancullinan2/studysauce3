...
<form action="<?php print ($view['router']->generate('command_callback')); ?>" method="post">
    ...
    <label class="input">
        ...
        <select name="options">
            ...
            <option value="<?php print ($view->escape('a:1:{s:2:"GHCB1617";a:1:{s:5:"price";d:29.99;}}')); ?>">29.99 (Great Hearts Bundle)</option>
        </select>
    </label>
    ...
    <div class="highlighted-link">
        ...
        <button type="submit" href="#submit" class="btn btn-primary" data-dismiss="modal">Add</button>
    </div>
</form>
<?php $view['slots']->stop();
